...
function broadcastDevices(io, roomId) {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("join", (payload, ack) => {
      ...
      const deviceMeta =
        ...
        payload?.deviceMeta &&
        typeof payload.deviceMeta === "object"
          ? payload.deviceMeta
          : {};
      ...
      devices.set(socket.id, {
        ...
        platform:
          typeof deviceMeta?.platform === "string" ? deviceMeta.platform : "unknown",
